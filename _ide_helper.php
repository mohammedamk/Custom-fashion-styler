...
')
     ...
     */ 
         ...
         *
         * @param string $data
         * @return \Code4mk\LaraHead\Head 
         * @static 
         */ 
        public static function setTitle($data)
        {
                        /** @var \Code4mk\LaraHead\Head $instance */
                        return $instance->setTitle($data);
        }
                    /**
         * get title meta
         *
         ...
         * @static 
         */ 
        public static function setMeta($name, $data = [])
        {
                        /** @var \Code4mk\LaraHead\Head $instance */
                        return $instance->setMeta($name, $data);
        }
                    /**
         * get single meta
         *
         ...
         * @static 
         */ 
        public static function setScript($name, $data = [])
        {
                        /** @var \Code4mk\LaraHead\Head $instance */
                        return $instance->setScript($name, $data);
        }
                    /**
         * get scripts
         *
         ...
         * @static 
         */ 
        public static function setLink($name, $data = [])
        {
                        /** @var \Code4mk\LaraHead\Head $instance */
                        return $instance->setLink($name, $data);
        }
                    /**
         * get link caa
         *
         ...
         * @static 
         */ 
        public static function setOg($data = [])
        {
                        /** @var \Code4mk\LaraHead\Head $instance */
                        return $instance->setOg($data);
        }
                    /**
         ...
         * @static 
         */ 
        public static function setTwitCards($data = [])
        {
                        /** @var \Code4mk\LaraHead\Head $instance */
                        return $instance->setTwitCards($data);
        }
                    /**
         * get twitter cards
         *
         * @static 
         */ 
        public static function getTwitCards()
        {
                        /** @var \Code4mk\LaraHead\Head $instance */
                        return $instance->getTwitCards();
        }
                    /**
...
namespace  { 
            ...
            class Khead extends \Code4mk\LaraHead\Facades\Khead {}
